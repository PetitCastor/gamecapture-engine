...
internal sealed class MainWindow : Form
{
    ...
    /// <summary>Un-minimizes, shows and activates the window. Used by the tray's "Show Ocrx"
    ...
    private void ShowInitializationFailure(Exception ex)
    {
        ...
        var message = new Label
        {
            ...
            Text = $"OCRX could not start its web view ({ex.Message}).\r\n\r\n"
    ...
    private static Icon LoadApplicationIcon()
    {
        ...
        // disk: Ocrx.Engine.csproj already embeds that file as ApplicationIcon (for Explorer
