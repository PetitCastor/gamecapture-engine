...
public static class PluginCatalog
{
    ...
    public const string StableCatalogUrl =
        "https://raw.githubusercontent.com/PetitCastor/ocrx-plugins/master/plugins.json";

    /// <summary>Opt-in catalog that older engines never request.</summary>
    public const string PreviewCatalogUrl =
        "https://raw.githubusercontent.com/PetitCastor/ocrx-plugins/master/plugins.preview.json";
    ...
    private const string CatalogPathPrefix = "/PetitCastor/ocrx-plugins/";

    private const string ReleaseHost = "github.com";

    /// <summary>Release assets live under this path on <c>github.com</c>.</summary>
    private const string ReleasePathPrefix = "/PetitCastor/ocrx-plugins/releases/";
