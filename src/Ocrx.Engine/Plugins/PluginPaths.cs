...
/// <c>%LOCALAPPDATA%\OCRX</c> rather than inside the engine's own Velopack install directory
/// (<c>%LOCALAPPDATA%\OcrxEngine</c>), so updating or uninstalling the engine leaves a user's
...
public static class PluginPaths
{
    ...
    /// <summary>Returns <c>%LOCALAPPDATA%\OCRX\plugins</c>.</summary>
