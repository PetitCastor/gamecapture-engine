...
/// </summary>
/// <remarks>
/// DELIBERATE FORK of <c>Ocrx.Sdk.ConsoleSink</c>, not an oversight, and not a candidate for
...
/// <para>
/// Namespace is <c>Ocrx.Engine</c> rather than <c>Ocrx.Engine.Core</c> so every engine file and
/// the engine's test project resolve <c>ConsoleSink</c> from their own enclosing namespace, ahead
/// of any <c>using Ocrx.Sdk;</c> at the top of the file. Moving it would make the SDK's copy
