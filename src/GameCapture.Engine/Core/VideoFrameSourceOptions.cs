...
internal sealed record VideoFrameSourceOptions
{
    ...
    /// <summary>
    /// When true, <see cref="VideoFrameSource.NextFrameAsync"/> waits for each frame's presentation
    /// time against a wall clock instead of returning frames as fast as they decode.
    /// </summary>
