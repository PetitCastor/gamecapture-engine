...
{
    [Fact]
    public void GetDefaultPath_UsesTheLocalApplicationDataOcrxDirectory()
    {
    ...
    {
        var directory = Path.Combine(Path.GetTempPath(), "Ocrx.Engine.Tests", Guid.NewGuid().ToString());
