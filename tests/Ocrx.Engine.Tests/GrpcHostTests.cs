...
/// and the generated client. The pieces that break in a split are the plumbing ones â€” pipe
/// naming, HTTP/2 without TLS, codegen wiring â€” and none of them show up in a unit test that
...
public class GrpcHostTests
{
    ...
    public async Task Track_OverNamedPipe_StreamsCorpusThenServesUnaryReads()
    {
        ...
        try
        {
            ...
            // sliver instead of failing â€” exactly the "wrong but plausible" outcome the guard exists
