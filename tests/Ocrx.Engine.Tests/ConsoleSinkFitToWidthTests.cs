...
/// <summary>
/// The same truth table <c>Ocrx.Sdk.Tests.ConsoleSinkFitToWidthTests</c> asserts, against the
/// engine's own copy of the class.
/// </summary>
/// <remarks>
/// A duplicated test for a deliberately duplicated class (see the remark on
/// <c>Ocrx.Engine/Operations/ConsoleSink.cs</c>): the two are allowed to drift, and the moment one of
