...
public class PluginCatalogTests
{
        ...
        [
          {
            ...
            "downloadUrl": "https://github.com/PetitCastor/ocrx-plugins/releases/latest/download/MissionPlugin-win-x64.zip"
          }
        ]
        """;
    ...
    {
        Assert.True(PluginCatalog.TryParse("""[{ "id": "mission-plugin", "name": "MissionPlugin", "description": "d", "downloadUrl": "https://github.com/PetitCastor/ocrx-plugins/releases/latest/download/MissionPlugin-win-x64.zip" }]""", out var entries, out _));
    ...
    public void TryParse_PreviewCatalog_RequiresPreviewEntries()
    {
        const string preview = """
            [{ "id": "mission-plugin", "name": "MissionPlugin", "description": "d",
               "downloadUrl": "https://github.com/PetitCastor/ocrx-plugins/releases/download/v1.0.17-mission-alpha.1/MissionPlugin-win-x64.zip",
               "channel": "preview" }]
            """;
    ...
    [Theory]
    [InlineData("https://github.com/PetitCastor/ocrx-plugins/releases/latest/download/A.zip")]
    [InlineData("https://github.com/PetitCastor/ocrx-plugins/releases/download/v1.0.4/A.zip")]
    ...
    [InlineData("https://github.com/attacker/PetitCastor/ocrx-plugins/releases/A.zip")]
    // Host that merely ends with an allowed one.
    [InlineData("https://evilgithub.com/PetitCastor/ocrx-plugins/releases/latest/download/A.zip")]
    // Allowed host in the userinfo of someone else's.
    [InlineData("https://github.com@evil.example/PetitCastor/ocrx-plugins/releases/A.zip")]
    // Trailing-dot spelling of the same host.
    [InlineData("https://github.com./PetitCastor/ocrx-plugins/releases/latest/download/A.zip")]
    // Non-default port.
    [InlineData("https://github.com:8443/PetitCastor/ocrx-plugins/releases/latest/download/A.zip")]
    // Plaintext transport.
    [InlineData("http://github.com/PetitCastor/ocrx-plugins/releases/latest/download/A.zip")]
    // Non-release path on the right repository.
    [InlineData("https://github.com/PetitCastor/ocrx-plugins/raw/master/A.zip")]
    ...
    public void ARedirectMayStillLandOnAnotherReleaseUrl()
        => Assert.True(PluginCatalog.IsTrustedRedirectTarget(
            new Uri("https://github.com/PetitCastor/ocrx-plugins/releases/download/v1.0.4/A.zip")));
    ...
    public void IsCatalogUrl_AcceptsOnlyTheTwoPublishedCatalogs()
    {
        ...
        Assert.False(PluginCatalog.IsCatalogUrl("https://raw.githubusercontent.com/PetitCastor/ocrx-plugins/master/other.json"));
    }
