...
internal sealed class FakePluginCatalogHandler : HttpMessageHandler
{
    ...
    public const string DownloadUrl = "https://github.com/PetitCastor/gamecapture-plugins/releases/latest/download/MissionPlugin-win-x64.zip";
    private const string ResolvedDownloadUrl = "https://github.com/PetitCastor/gamecapture-plugins/releases/download/v1.2.3/MissionPlugin-win-x64.zip";
